...
public class PastRequestFragment extends Fragment {
    ...
    BaseOnClickListener onClickListener = new BaseOnClickListener() {
        ...
        public void baseOnClick(Request request) {
            ...
            ((MainActivity)getActivity()).displayFragment(MainActivity.FRAGMENT_PAST_DETAIL,bundle,true);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null){
            view = inflater.inflate(R.layout.fragment_past_request,container,false);
